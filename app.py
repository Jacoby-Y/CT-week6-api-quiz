...
class User(db.Model):
    ...
    def from_dict(self, data):
        ...
        if 'password' in data: self.password = self.hash_password(data['password'])
...
class Recipe(db.Model):
    ...
    def from_dict(self, data):
        ...
        if 'user_id' in data: self.user_id = data['user_id']
...
def put_recipe(id):
    ...
    return make_response("recipe doesn't exist!", 400)
